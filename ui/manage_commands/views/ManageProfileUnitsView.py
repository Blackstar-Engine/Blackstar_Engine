...
class SubmitButtonRow(ui.ActionRow):
    ...
    async def profile_manage_units_submit(self, interaction: discord.Interaction):
        ...
        await log_action(ctx=interaction, log_type="department", user_id=self.profile.get("user_id"), department=', '.join(active_units) or 'None', command_name="manage profile")
